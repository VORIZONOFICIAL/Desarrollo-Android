...
import com.example.horza_one_god.databinding.ActivityAdminBinding;
...
public class Admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.asis_acc, R.id.nav_slideshow)
...
//            if (id == R.id.salir) {
//                Intent intent = new Intent(Admin.this, Panel_Seleccion_Rol.class);
